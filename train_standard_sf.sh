...
touch train_logs_sf.txt
chmod 755 train_logs.txt
> train_logs_sf.txt

rm -rf FT3d_sf.txt
#python -u train_sf.py --name raft-things_sf --stage things --validation things --gpus 0 --num_steps 100000 --batch_size 6 --lr 0.000125 --image_size 400 720 --wdecay 0.0001 >> train_logs_sf.txt
python -u train_sf.py --name raft-things_sf --stage things --validation things --gpus 0 --num_steps 250000 --batch_size 6 --lr 0.000125 --image_size 400 720 --wdecay 0.0001 --iters 12 >> train_logs_sf.txt

...
class FlowDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if dataset=='Kitti':
            ...
            scene_flow = torch.stack([flow[0,:,:], flow[1,:,:], disparity[0,:,:], disparity[1,:,:], disparity_change[0,:,:] + flow[0,:,:], disparity_change[1,:,:] + flow[0,:,:]], dim = 0)
            ...
            scene_flow = torch.stack([flow[0,:,:], flow[1,:,:], disparity[0,:,:], disparity[1,:,:], disparity[0,:,:]+disparity_change[0,:,:] + flow[0,:,:], disparity[1,:,:]+disparity_change[1,:,:]+flow[0,:,:]], dim=0)
